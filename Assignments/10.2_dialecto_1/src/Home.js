  ...
  return (
    <div>
      <div className="language-container">
        ...
        <span onClick={(e)=>{changeLanguage(e,"English")}}>English</span>
        <span onClick={(e)=>{changeLanguage(e,"Hindi")}}>Hindi</span>
        <span onClick={(e)=>{changeLanguage(e,"Marathi")}}>Marathi</span>
      </div>
